...
from passwork_client.crypto import (
    ...
    generate_rsa_keys, generate_user_rsa_keys, evp_bytes_to_key
)
...
class TestCrypto:
    ...
    def test_rsa_encrypt_decrypt(self):
        ...
        encrypted_data = rsa_encrypt(data, rsa_keys["public"])

        decrypted_data = rsa_decrypt(base64.b64encode(encrypted_data), rsa_keys["private"])

        assert decrypted_data.decode() == data

    def test_generate_user_rsa_keys(self):
        """Test RSA key pair generation and encryption of private key"""
        master_key = "test_master_key"

        result = generate_user_rsa_keys(master_key)
